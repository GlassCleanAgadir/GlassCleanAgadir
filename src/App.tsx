        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4 ml-4">
              ...
              <a href="tel:+212600000000" className="flex items-center gap-2 text-blue-600 font-bold">
                <Phone size={18} />
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:+212600000000" className="flex items-center gap-2 text-blue-600 font-bold text-lg">
                <Phone size={20} />
                <span dir="ltr">+212 600-000000</span>
              </a>
              <button 
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?auto=format&fit=crop&q=80&w=2000" 
          alt="Clean Windows" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/212600000000" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center hover:bg-green-500 transition-colors">
                <MessageCircle size={24} />
              </a>
              <a href="#" className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors">
                <Mail size={24} />
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-blue-100/60">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@agadirwindow.ma</span>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={cn(
              ...
              <div className="flex-1 relative">
                ...
                />
                <div className={cn(
                  "absolute -bottom-8 bg-white p-8 rounded-3xl shadow-xl z-20 hidden md:block",
